/**
 * @file lv_conf.h
 * @brief LVGL compile-time configuration for ESP32-S3 LCD display (ADR-045).
 *
 * Tuned for ST7789V2 240x280 SPI LCD with 8MB PSRAM.
 * Color depth: RGB565 (16-bit) for SPI bandwidth.
...
/* ---- GPU / render ---- */
#define LV_USE_GPU_ESP32_S3     0   /* No parallel LCD interface — we use SPI */
